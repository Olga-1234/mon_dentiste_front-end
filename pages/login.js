...
const login = ({email, passsword}) => {
  ...
  return (
    <div className="d-flex col">
      <NavBar/>
    <div className={`d-flex col-6 justify-content-center align-items-center ${style.login}`}>
      
      <form className={`col-lg-7 row g-5   ${style.respensivepadding}`} onSubmit={handleSubmit(onSubmit)}>
